        ...
        <div id="content">
            <div id="wrap_content_header">
                <div id="content_header">
                    <input id="radio_free" type="radio" name="board_check" value="free" checked>
                    <input id="radio_travel" type="radio" name="board_check" value="travel">
            ...
            <div id="board">
            	 <c:set var="maxPageNum" value="${bfMaxPageNum}"/>
            	 <c:choose>
	            	 <c:when test="${maxPageNum != 0}">
		                <table>
		                    ...
		                    <c:forEach var="bfList" items="${bfList}" varStatus="status">
		                     <tr>
		                      <td>${bfList.bSubNum}</td>
		                      <td>${bfList.bSort}</td>
		                      <td>
		                      	<a href="/bfpost/${bfList.bNum}">
                ...
                <c:if test="${userInfo != null}">
                    <a id="board_write" href="/bfwrite">글쓰기</a>
                </c:if>
            </div>
	            ...
	            <div id="wrap_board_num">
	            	<ul>
	             	...
	             	<c:forEach var="i" begin="1" end="${maxNum}" step="1">
	             		<c:choose>
		             		<c:when test="${bfPageColor == i}">
		             			<li><a id="pagenumcolor" href="/bflist/${i}">${i}</a></li>
		             		</c:when>
		             		<c:otherwise>
		             			<li><a href="/bflist/${i}">${i}</a></li>
		             		</c:otherwise>
	          			</c:choose>
	             	</c:forEach>
	            	</ul>
